...
```text
Use AGENTS.md, the korean-executive-html-report skill, and the refero-design skill.
...
4. Refero 스타일→화면→흐름 조사 결과에서 주 레퍼런스를 잠그고, references 배열에 적용 원칙과 이미지 URL을 남김
5. HTML 덱 생성
6. 자체 품질 체크 결과 제시
```
