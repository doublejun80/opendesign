...
description: Convert an accepted Open Design artifact into a Next.js App Router handoff. Use when exporting a design artifact to a Next.js route, layout fragment, or reusable component.
---
