---
name: od-vue-export
description: Convert an accepted Open Design artifact into a Vue 3 single-file component handoff. Use when exporting a design artifact to Vue while preserving visuals, assets, and component boundaries.
---
