...
description: Convert an accepted Open Design artifact into a React component handoff. Use when exporting a design artifact to React while preserving the visual system and interaction assumptions.
---
