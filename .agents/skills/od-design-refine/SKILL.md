...
description: Improve an existing Open Design artifact with focused critique, a small patch, and a handoff summary. Use when refining or polishing an Open Design result rather than creating a new one.
---
